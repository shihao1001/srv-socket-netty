...
public class ServerHandler extends ChannelInboundHandlerAdapter {
	...
	private void handlerRequest(CometContext context) {
		...
		case SEND_MESSAGE: {
			...
			ActionProbuf.Action.Builder newBuilder = action.newBuilderForType()
					.setActionType(ActionType.RECEIVE_MESSAGE);
	...
	public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause)
		...
		if (cause instanceof IOException || cause instanceof IOError) {
			...
			logger.error("TooLongFrameException, close channel: "
